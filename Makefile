...
util.o: base.h opts.def
code.o: base.h opts.def
ast.o: base.h opts.def ast.h ir.h
ir.o: base.h opts.def ir.h
conout.o: base.h opts.def
ftepp.o: base.h opts.def lexer.h
opts.o: base.h opts.def
fs.o: base.h opts.def
utf8.o: base.h opts.def
